...
//      logInfo(
//          "Count of missing predicate combinations for tsc '${tsc.identifier}':
// ${missedPredicates.size}.")
//      missedPredicates
...
//   * @return A [Set] of [PredicateCombination]s that can occur based on the given [tsc] but are
// not
...
//   *
//   * @param tscInstances A [List] of [TSCInstanceNode] for which all possible
...
//      // Get all traversals that are possible for the current TSCInstance, excluding
// TSCAlwaysEdges,
