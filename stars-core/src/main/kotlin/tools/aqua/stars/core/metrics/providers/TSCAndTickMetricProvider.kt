 ...
 * [evaluate] function which gets a [TSC] and the current [TickDataType] and is called during the
 * evaluation phase.
 *
 * @param E [EntityType].
 ...
 */
interface TSCAndTickMetricProvider<
...
> : EvaluationMetricProvider<E, T, U, D> {
   ...
   */
  fun evaluate(tsc: TSC<E, T, U, D>, tick: T): Any?
}
