...
/**
 * This class implements the [TSCAndTSCInstanceMetricProvider] interface and tracks the invalid
...
class InvalidTSCInstancesPerTSCMetric<
    ...
    D : TickDifference<D>,
>(
    override val identifier: String = "invalid-tsc-instances-per-tsc",
