...
//   * @throws IllegalStateException when the resulting size of the [MutableMap] is not equals to
// the
...
//      logInfo(
//          "Count of unique missed instances for tsc '${tsc.identifier}': ${missedInstances.size}
// (of ${tsc
