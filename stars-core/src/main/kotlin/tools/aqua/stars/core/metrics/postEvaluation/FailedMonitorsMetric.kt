...
import tools.aqua.stars.core.serialization.SerializableFailedMonitorInstance
import tools.aqua.stars.core.serialization.SerializableFailedMonitorsResult
...
>(
    ...
    override val identifier: String = "failed-monitors",
