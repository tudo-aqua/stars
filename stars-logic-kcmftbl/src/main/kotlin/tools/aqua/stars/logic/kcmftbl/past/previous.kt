...
fun <
    ...
    U : TickUnit<U, D>,
    D : TickDifference<D>,
> previous(tickData: T, interval: Interval<D>? = null, phi: (T) -> Boolean): Boolean {
  ...
  val diff = tickData.currentTickUnit - previousTick.currentTickUnit
  if (diff.isNotIn(interval)) return false
