...
class TestUntil {
  ...
  fun `Test when phi2 is true at current time, while no interval is given`() {
    ...
    assertTrue { until(createTicks(phi1, phi2)[0], null, phi1 = { it.phi1 }, phi2 = { it.phi2 }) }
  }
  ...
  fun `Test when phi1 and phi2 are false, while no interval is given`() {
    ...
    assertFalse { until(createTicks(phi1, phi2)[0], null, phi1 = { it.phi1 }, phi2 = { it.phi2 }) }
  }
