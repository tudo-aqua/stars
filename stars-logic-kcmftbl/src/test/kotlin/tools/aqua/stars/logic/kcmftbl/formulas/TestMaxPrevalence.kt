...
class TestMaxPrevalence {
  ...
  fun `Test when phi is false and percentage is 80, while no interval is given`() {
    ...
    assertTrue { maxPrevalence(createTicks(phi)[0], percentage, null, phi = { it.phi1 }) }
  }
  ...
  fun `Test when phi is true for 7 of 10 ticks and percentage is 80, while no interval is given`() {
    val phi = listOf(1, 1, 1, 1, 1, 1, 0, 1, 1, 1)
    val percentage = 0.8

    assertFalse { maxPrevalence(createTicks(phi)[0], percentage, null, phi = { it.phi1 }) }
  }
  ...
  fun `Test when phi is true for 8 of 10 ticks and percentage is 80, and 4 of 5 in interval are true`() {
    ...
    assertTrue {
      maxPrevalence(createTicks(phi)[0], percentage, createInterval(interval), phi = { it.phi1 })
    }
  }
  ...
  fun `Test when phi is true for 8 of 10 ticks and percentage is 80, and 5 of 5 in interval are true`() {
    val phi = listOf(1, 1, 1, 1, 1, 0, 0, 1, 1, 1)
    val percentage = 0.8
    val interval = 0 to 5
  ...
  fun `Test percentage less than 0`() {
    ...
    assertFailsWith<IllegalArgumentException> {
      maxPrevalence(createTicks(phi)[0], percentage, null, phi = { it.phi1 })
    }
  }
