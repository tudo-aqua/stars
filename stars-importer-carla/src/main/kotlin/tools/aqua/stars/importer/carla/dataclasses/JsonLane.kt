...
data class JsonLane(
    ...
    @SerialName("predecessor_lanes") val predecessorLanes: List<JsonContactLaneInfo> = listOf(),
    @SerialName("successor_lanes") val successorLanes: List<JsonContactLaneInfo> = listOf(),
    @SerialName("intersecting_lanes") val intersectingLanes: List<JsonContactLaneInfo> = listOf(),
    @SerialName("lane_midpoints") val laneMidpoints: List<JsonLaneMidpoint> = listOf(),
    @SerialName("speed_limits") val speedLimits: List<JsonSpeedLimit> = listOf(),
    @SerialName("landmarks") var landmarks: List<JsonLandmark> = listOf(),
    @SerialName("contact_areas") val contactAreas: List<JsonContactArea> = listOf(),
    @SerialName("traffic_lights") var trafficLights: List<JsonStaticTrafficLight> = listOf(),
)
